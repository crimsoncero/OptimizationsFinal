Shader "ArcticCastle/SURFPBR_TopBlend" {
    Properties {
    ...
    SubShader {
        ...
        sampler2D _MainTex, _Spc, _BumpMap, _AO, _DetailBump, _layer1Tex, _layer1Norm;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {       
            ...
            //IN.color = saturate(IN.color + _VMask);
            IN.color = IN.color + _VMask;
            //half blend2 = saturate((blend * _Power + _Shift) * IN.color);
